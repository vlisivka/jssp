...
public class CommonFuncs {
    ...
    public static void includeJssp(ApplicationContext application, Scriptable scope, String jsspName,
    ...
    public static String executeJssp(ApplicationContext application, Scriptable scope, String jsspName,
    ...
    public static void executeJssp(ApplicationContext application, Scriptable scope, String jsspName,
	    Scriptable parameters, OutputStream outputStream) throws IOException {
	executeJssp(application, scope, jsspName, parameters, new OutputStreamWriter(outputStream));
    }

    public static void executeJssp(ApplicationContext application, Scriptable scope, String jsspName,
	    Scriptable parameters, Writer outputWriter) throws IOException {
	...
	// WARNING: synchronize(jsspCache) removed, but this code safe (jssp
	// page may be compiled twice)
    ...
    public static String executeJsspWithDefaultScope(ApplicationContext application, String jsspName,
	    Scriptable parameters) {
	try {
	    StringWriter stringWriter = new StringWriter();
    ...
    public static void executeJsspWithDefaultScope(ApplicationContext application, String jsspName,
	    Scriptable parameters, OutputStream outputStream) throws IOException {

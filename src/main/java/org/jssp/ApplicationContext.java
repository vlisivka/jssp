...
public class ApplicationContext
{
  ...
  //Global scope for all Java Scripts, we can modify it only in initialization script
  ...
  private void reinit()
  {//Reload configuration if one of configuration files is changed
  ...
  public void showJsspPage(String pageName,Scriptable rs,Writer out) throws Exception
  {
    ...
    if(pageName!=null)
    {
      ...
      //Put some variables into script scope ( session, request, response, etc. ) so we can call it directly
      ...
      if(tmp!=Scriptable.NOT_FOUND)
        ...
        throw new RuntimeException("Property \"file\" is required for page description! (page \""+pageName+"\"");
      ...
      CommonFuncs.executeJssp(this,scope,file,rs,response.getWriter());
    }
  }

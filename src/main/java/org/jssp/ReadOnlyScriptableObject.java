...
public class ReadOnlyScriptableObject extends ScriptableObject
{
   ...
   * by Object.prototype.toString() in ECMA.<p>* See ECMA 8.6.2 and 15.2.4.2.
   */
   ...
   *<p>* The property is specified by a string name
   * as defined for<code>get</code>.
   *<p>* The possible values that may be passed in are as defined for
   ...
   * properties are effectively read-only.<p>* For a more convenient(and less efficient) form of this method,* see<code>putProperty</code>in FlattenedObject.<p>* Note that if a property<i>a</i>is defined in the prototype<i>p</i>* of an object<i>o</i>,then evaluating<code>o.a=23</code>will cause
   ...
   * object's responsibility to modify<i>o</i>.<p>* This design allows properties to be defined in prototypes and implemented
   * in terms of getters and setters of Java values without consuming slots
   * in each instance.<p>* Note that<code>has</code>will be called by the runtime first before
   *<code>set</code>is called to determine in which object the
   * property is defined.
   * Note that this method is not expected to traverse the prototype chain,* which is different from the ECMA [[Put]] operation.
   * @param name the name of the property
  ...
  public void put(String name,Scriptable start,Object value)
  {
    ...
    {
      throw new RuntimeException("Can't put \""+name+"\" property to read-only object \""+getClassName()+"\"");
    }
  }
  
  /**
   * Sets an indexed property in this object.
   *<p>* The property is specified by an integral index
   ...
   *<p>* A property can be made permanent by ignoring calls to remove
   * it.<p>* The property is specified by a String name
   * as defined for<code>get</code>.
   *<p>* For a more convenient form of this method,* see deleteProperty in FlattenedObject.
  ...
  public void delete(String name)
  {
    ...
    {
      throw new RuntimeException("Can't delete \""+name+"\" property from read-only object \""+getClassName()+"\"");
    }
  }
   ...
   *
   *<p>* The JavaScript code "lhs instanceof rhs" causes rhs.hasInstance(lhs) to
   * be called.
   *
   *<p>* The return value is implementation dependent so that embedded host objects can
